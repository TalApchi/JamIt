...
// SAME resolver + AudioEngine the real Kalimba uses:
//   button -> target MIDI -> resolveKalimbaSample -> AudioEngine -> speaker
// Nothing here goes through ScaleInstrument/KalimbaInstrument. If two
// buttons still sound identical, the bug is in resolveKalimbaSample/
...
export function AudioDebugScreen({ onExit }: Props) {
  const audioEngine = useRef(new AudioEngine(resolveKalimbaSample)).current;
  ...
  return (
    <View style={styles.screen}>
      <Text style={styles.title}>Audio Debug — Kalimba</Text>
      <Text style={styles.subtitle}>
        Button → target MIDI → resolveKalimbaSample → AudioEngine. No scale, degree, touch, or calibration
        logic involved.
      </Text>
