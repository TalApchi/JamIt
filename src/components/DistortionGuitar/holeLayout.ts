...
// y~430-980.
//
// Pad-to-note mapping is intentionally REVERSED from the natural low-to-high
// left-to-right reading: the user wants the higher octave on the left.
// Degrees 1-7 (left 7 pads) play octave 5 (scale degree N, +1 octave);
// degrees 8-14 (right 7 pads) play octave 4 (scale degree N-7, no shift) --
// see DistortionGuitarInstrument.tsx's resolveDegree.
